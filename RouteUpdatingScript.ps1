# Customer Variables
$VNetId = 'ffdff318-7693-4591-af1a-94822361e367' #Found in the VPN Setting configuration
$FileShareHostList = @('test445.file.core.windows.net') # All Storage Accounts that should use this VPN connection
